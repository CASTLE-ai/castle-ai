...
| **A-06** | **Latent 抽取方式改進** | 🔴 High | Medium | ✅ 完成 (`49178a0`) — Plan C multi-scale SPP + multi-layer |
...
| **B-04** | **Undo/Redo 機制** | 🟢 Low | Large | ✅ 完成 (`574a47f`→`19b19a1`) — Command Pattern, history_service.py |
| **A-05** | **PyQt Desktop 前端** | 🟢 Low | Large | ✅ 完成 (`c55c8da`→`161221c`) — PyQt6 + pyqtgraph, 5 tabs |
